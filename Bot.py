...
cl = LINETCR.LINE()
cl.login(token="EqrenQBUm36xyH7Mj5Y9.0aRh9UCw6Vqjz/nZQz5Ckq.8Be7g9OP04a/nhAn++d+cehf4obfezCbs+Nmaksb0LE=")
cl.loginResult()
...
autoleaveroom = []
targets = []
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,"ud00ac7f6e716eaf40967e373a99e5c29",""]
