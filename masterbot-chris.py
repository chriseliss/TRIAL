...
import time, random, sys, ast, re, os, io, json, subprocess, threading, string, codecs, requests, tweepy, ctypes, urllib, urllib2, wikipedia, goslate, unicodedata
import timeit
...
#==========================================================
KAC=[ki,kk,kc,ks,kt,kl,ki1,ki2,ki3,ki4]
DET=[cl]
...
Gmid = ki1.getProfile().mid
Hmid = ki2.getProfile().mid
Imid = ki3.getProfile().mid
Jmid = ki4.getProfile().mid
...
staff = [""]
admin = ["ud00ac7f6e716eaf40967e373a99e5c29"]
owner = ["u02daeb9deaf90e5498e87650f65858af","ud00ac7f6e716eaf40967e373a99e5c29"]
creator = ["ud00ac7f6e716eaf40967e373a99e5c29"]
...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Salam kenal...Thanks for add",
    "lang":"JP",
    "comment":"DEKRADAKZ PROTECTION",
    "welmsg":" Welcome to group. Nice to know you~ ",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#========================================================================
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == admin + owner + creator:
                    if "join:" in msg.text:
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
                   ...
                   if msg.contentMetadata["mid"] in wait["blacklist"]:
                        ...
                        wait["dblacklist"] = False
                        cl.sendText(msg.to,"It is not in the blacklist")
...
#==================================================
              ...
              if msg.from_ in owner and creator:
                    ...
                    try:
                        cl.sendText(msg.to,"Restarting...wait a moment")
                        restart_program()
                    except:
              ...
              if msg.from_ in admin + owner + creator:
		        ...
		        cl.sendText(msg.to, str(njer))
            elif 'cancelall' in msg.text.lower():
               if msg.from_ in admin:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
...
#==================================================================
              ...
              if msg.from_ in admin + owner + creator:
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': 'ud00ac7f6e716eaf40967e373a99e5c29'}
                cl.sendMessage(msg)
...
#-----------------------------------------------------------
                ...
                if msg.from_ in owner:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                admin.append(target)
                                cl.sendText(msg.to,"has been promoted as admin")
                            except:
                                pass
                    print "[Command]Staff add executed"
                else:
                ...
                if msg.from_ in owner:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                admin.remove(target)
                                cl.sendText(msg.to,"has been expelled as admin")
                            except:
                                pass
                    print "[Command]Staff remove executed"
                else:
                ...
                if msg.from_ in creator:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                owner.append(target)
                                cl.sendText(msg.to,"has been promoted as Owner")
                            except:
                                pass
                    print "[Command]Staff add executed]"
                ...
                if msg.from_ in creator:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                owner.remove(target)
                                cl.sendText(msg.to,"has been expeled as Owner")
                            except:
                                pass
                    print "[Command]Staff remove executed"
                else:
            ...
            elif "Antibot @" in msg.text:
                if msg.from_ in owner:
                    print "[Command]Staff add executing"
                    _name = msg.text.replace("Antibot @","")
                    _nametarget = _name.rstrip(' ')
                    gs = cl.getGroup(msg.to)
                    targets = []
                    for g in gs.members:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                Bots.append(target)
                                cl.sendText(msg.to,"has been add to Antibot")
                            except:
                                pass
                    print "[Command]Staff add executed]"

            elif "Antibot off @" in msg.text:
                if msg.from_ in creator:
                    print "[Command]Staff remove executing"
                    _name = msg.text.replace("Antibot off @","")
                    _nametarget = _name.rstrip(' ')
                    gs = cl.getGroup(msg.to)
                    targets = []
                    for g in gs.members:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                Bots.remove(target)
                                cl.sendText(msg.to,"has been removed from Antibot")
                            except:
                                pass
                    print "[Command]Staff remove executed"
                else:
...
#=================================================================
            elif msg.text in ["Protect:high","protect:high"]:
              if msg.from_ in admin + owner + creator:
                if wait["protectionOn"] == True:
                    if wait["lang"] == "JP":
                    ...
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"High Protection ON\n\n"+ datetime.today().strftime('%H:%M:%S'))
                    else:
                        cl.sendText(msg.to,"High Protection ON\n\n"+ datetime.today().strftime('%H:%M:%S'))
              ...
              if msg.from_ in admin + owner + creator:
                if wait["protection"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Protection off Already\n\n"+ datetime.today().strftime('%H:%M:%S'))
            elif msg.text in ["qr off","protectqr:off"]:
              if msg.from_ in admin + owner + creator:
                if wait["qr"] == False:
                    if wait["lang"] == "JP":
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Already off\n\n"+ datetime.today().strftime('%H:%M:%S'))
            elif msg.text in ["Welcomemessage on"]:
              if msg.from_ in admin + owner + creator:
                if wait["welcomemsg"] == True:
                    if wait["lang"] == "JP":
              ...
              if msg.from_ in admin + owner + creator:
                if wait["qr"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Already ON")
            elif msg.text in ["Welcomemessage off"]:
              if msg.from_ in admin + owner + creator:
              ...
              if msg.from_ in admin + owner + creator:
                if wait["protectionOn"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Low Protection MODE\n\n"+ datetime.today().strftime('%H:%M:%S'))
                    else:
                        cl.sendText(msg.to,"Low Protection MODE\n\n"+ datetime.today().strftime('%H:%M:%S'))
                else:
...
#============================================================
              ...
              if msg.from_ in admin + owner + creator:
                ...
                cl.sendMessage(msg)
#=======================================================
            elif msg.text in ["Autonotice:on"]:
              if msg.from_ in admin + owner + creator:
                if wait["contact"] == True:
                    if wait["lang"] == "JP":
...
#=========================================================================
            elif msg.text in ["Autonotice:off"]:
              if msg.from_ in admin + owner + creator:
              ...
              if msg.from_ in admin + owner + creator:
                if wait["autoJoin"] == True:
                    ...
                    wait["autoJoin"] = True
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Enable auto join")
                    else:
                        cl.sendText(msg.to,"")
              ...
              if msg.from_ in admin:
                if wait["autoJoin"] == False:
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Disable auto join")
                else:
                    wait["autoJoin"] = False
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Already unactivated")
...
#========================================
              ...
              if msg.from_ in admin + owner + creator:
                ...
                cl.sendText(msg.to,"update welcome message successfully"+ datetime.today().strftime('%H:%M:%S'))
...
#===========================================
              ...
              if msg.from_ in admin + owner + creator:
                cl.sendText(msg.to, "Bot prepare...")
                profile = cl.getProfile()
...
#========================================
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    cl.sendText(msg.to,"Tidak bisa dilakukan di luar grup","/nCannot do out of the group")
...
#===============================================
              ...
              if msg.from_ in admin:
                  if msg.toType == 2:
                       ...
                       gs = cl.getGroup(msg.to)
                       cl.sendText(msg.to,"Semua Akan Di Hapus")
                       targets = []
                       for g in gs.members:
            ...
            elif msg.text in ["Ban cek","Cekban","banlist"]:
              if msg.from_ in admin:
                if msg.toType == 2:
                    group = cl.getGroup(msg.to)
...
#--------------------------------------------------------
		...
		if msg.from_ in admin:
		    ...
		    for gid in wait["BlGroup"]:
			    ...
			    cl.sendText(msg.to, "Banlist has been deleted. "+ng)
		        else:
			    pass
		else:
		    cl.sendText(msg.to, "Khusus Admin")
...
#--------------------------------------------------------
		...
		if msg.from_ in creator:
                    for i in gid:
                        h = cl.getGroup(i).name
		        if h == ng:
			    cl.sendText(i,"Bot dipaksa keluar oleh owner!")
		            cl.leaveGroup(i)
			    ki.leaveGroup(i)
			    kk.leaveGroup(i)
			    kc.leaveGroup(i)
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                f=codecs.open('st2__b.json','w','utf-8')
                                json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                                cl.sendText(msg.to,"has been removed from Banlist")
                            except:
                                cl.sendText(msg.to,"There was no blacklist user")
            elif msg.text in ["Clear banlist"]:
              if msg.from_ in owner and creator:
				wait["blacklist"] = {}
				cl.sendText(msg.to,"All banlist has been clear")
...
#============================================
            ...
            elif msg.text in ['Tagall',"tagall","absen","Absen","Toel","toel"]:
                group = cl.getGroup(msg.to)
