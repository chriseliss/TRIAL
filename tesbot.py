...
cl = LINETCR.LINE()
cl.login(token="EqW8jJIdDK4cn4tD2xJf.aTRRNER5dLsy6hzq9LHyRW.UQbVeDMmya1GkRwQlbI4AP55zU0ynRkct/6RkUuyE+o=")
cl.loginResult()
...
wait = {
    ...
    'leaveRoom':False,
    'timeline':False,
	"comment":"Add my creator http://line.me/ti/p/~christ.ambassador",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#==========AUTOWELCOME=================
		if op.type == 17:
			if wait["welcome"] == True:
				...
				print("MEMBER HAS JOINED THE GROUP")
	#===========AUTOBYE===================
        if op.type == 15:
            if op.param2 in admin:
                return
            cl.sendText(op.param1, "Tukan tukan dikit2 baper \n Moga tenang disana dan amal ibadahnya di trima disisi allah ya kak 😢")
...
#==============================================================================#
                 ...
                 if jml > 200  and jml < 500:
                    ...
                    summon(msg.to, nm5)
                 if jml > 500:
                     print("<< Jumlah member terlalu banyak >> 500+")
                 cnt = Message()
                 cnt.text = "Jumlah:\n" + str(jml) +  " Members"
                 cnt.to = msg.to
                 cl.sendMessage(cnt)
...
#==============================================================================#
                ...
                try:
                    ...
                    print("[Notif] Search Image Google Success")
...
#============AUTOSIDER====================
		if op.type == 55:
			try:
				if autosider['cctv'][op.param1]==True:
					if op.param1 in autosider['siderpoint']:
						Name = cl.getContact(op.param2).displayName
						if Name in autosider['sidercek'][op.param1]:
							pass
						else:
							autosider['sidercek'][op.param1] += "\n• " + Name
							if " " in Name:
								nick = Name.split(' ')
								if len(nick) == 2:
