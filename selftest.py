...
cl = LINETCR.LINE()
cl.login(token="EqZ2xOvINtf2DmPdpief.aTRRNER5dLsy6hzq9LHyRW.QAqk+pKwagzMaHuf4ryrSjybtqmv1PteaoArYyrh9J0=")
cl.loginResult()

kt = LINETCR.LINE()
kt.login(token="Eq3tdCgGEnYScIUQ2hld.y4HIyjJAHM42pOS+pQLchq.BtKMJuCVKX2R/iDGuBzDGSxawnERm/mOhUyz54s5rBI=")
kt.loginResult()

ks = LINETCR.LINE()
ks.login(token="EqkaJcDzSiDdpA9isBU7.QC3K9qYU90/BKYAyZOi4HW.qRicVgcaRqZMo3O9Q4C5etDbboZ9J0nz2K7GVy7PhuM=")
ks.loginResult()

ki = LINETCR.LINE()
ki.login(token="EquGZvTRuiojk1bZAqKd.VqKvgR1VN+EOBMg8OYQC3q.ry6GW1y5eUiLAsXah07g7DiAWAwIzInXOLwECxEVMpM=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="EqiB0oFp5bXAtXR0YgHa.bZuOZXpfOqVDlRG1hE2/cG.WurHA6wsQpjxi5mWN6fwFoNU6Y1dLwJuzhRlmOnEA+s=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="Eqrd91YQ8XdGhVjHhXx4.CXkMGnyUWjQ1YA6pOpEFfa.wBpXeQP5SFfxVCqmIEBcXKEaANJfTkEQSCfS3Pz7Hns=")
kc.loginResult()

kl = LINETCR.LINE()
kl.login(token="Eqbd8aDkjbZk4caESnkd.TX1aQQXxOJrBdg7tSjhSBq.t4ibbAqHQxd83tiiKN2Hs37ULj15PQuASxQgOD/Blek=")
kl.loginResult()
...
admin = ["u02daeb9deaf90e5498e87650f65858af"]
owner = ["ud00ac7f6e716eaf40967e373a99e5c29"]
...
#================================================================================
	      ...
	      if msg.from_ in admin + owner + creator:
              ...
              if msg.from_ in "u02daeb9deaf90e5498e87650f65858af":
                if msg.toType == 2:
